                                                    ...
                                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form method="POST"
                                                                        action="suppliers.php?action=add&id=<?php echo $value['id']?>">
                                                                ...
                                                                <td id="price<?php echo $value['id'] ?>">
                                                                    <?=$value['productPrice']?>/Kg</td>
                                                                <td>
                                                                    <button class="btn btn-sm btn-primary mr-1 mb-1"
                                                                        name="add_to_cart"><i
                                                                            class="fa fa-plus"></i>AddToCart</button>
                                        </form>
                                        <!--  -->
                            ...
                            <tbody>
                                ...
                                <form method="post" action="process_supplier.php">
                                    <tr>
                                        ...
                                        <td><?php echo $values['item_price']; ?>/Kg</td>
                                        <td><?php echo number_format($values['item_quantity'] * $values['item_price'] , 2); ?>
                                        </td>
                                        <td><a href="suppliers.php?action=delete&id=<?php echo $values['item_id']; ?>"><span
                                                    style="font-size: 19px;" class="text-align text-danger la la-trash"
                                    ...
                                    <tr>
                                        ...
                                        <td style="margin-left: -30px;">
                                            <a href="#myModal" data-toggle="modal" data-target=""
                                                class="btn btn-success la la-shopping-cart" style="width: 50px;">
                                        </td>
                                    </tr>
                                    <?php }
                                                 // else
...
function addquantity(id) {
    ...
    document.getElementById("quantity" + id).innerHTML =
        "<input type='text' class='form-control' autofocus id='quantity_text" + id + "' value='" + quantity + "'>";
