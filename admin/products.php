                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                ...
                                                //     echo $name;
                                                // }
                                                    $results = $object->getProducts($productCategory);
                                                    if(!empty($results)){
                                                    $i=1;
                    ...
                    $.ajax({
                        ...
                        success: function(inputValue) {
                            if (inputValue == "success") {
                                ...
                                swal("Error", "Your Record is safe", "error");
                            }
...
function edit_product(id) {
    ...
    document.getElementById("productName" + id).innerHTML =
        "<input type='text' class='form-control' autofocus id='productName_text" + id + "' value='" + productName +
        "'>";
    document.getElementById("productPrice" + id).innerHTML =
        "<input type='text' class='form-control' id='productPrice_text" + id + "' value='" + productPrice + "'>";
    document.getElementById("productQuantity" + id).innerHTML =
        "<input type='text' class='form-control' id='productQuantity_text" + id + "' value='" + productQuantity + "'>";
