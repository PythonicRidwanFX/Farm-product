                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                ?>
                                <h4 class="card-title"><a href="#myModal" data-toggle="modal" data-target=""
                                        class="btn btn-primary "><i class="la la-plus"></i>New Category</a></h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?=$i?></td>
                                                    <td id="name<?php echo $value['id'] ?>"> <a
                                                            href="products.php?productCategory=<?=$value['id']?>">
                                                            <?=$value['name']?> </a> </td>
                                                    ...
                                                    <td>
                                                        <a title="Edit" href="#"
                                                            ...
                                                            onclick="edit_cat('<?php echo $value['id'];?>');"
                                                        ...
                                                        <a title="Edit" href="#"
                                                            ...
                                                            onclick="save_cat('<?php echo $value['id'];?>');"
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="catName" class="form-control mb-1" required
                                        data-validation-required-message="Category name is required" required>
                                </div>
                            </div>
                        </div>
...
function edit_cat(id) {
    ...
    document.getElementById("name" + id).innerHTML = "<input type='text' class='form-control' autofocus id='name_text" +
        id + "' value='" + name + "'>";
