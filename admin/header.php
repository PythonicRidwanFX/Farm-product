...
<body class="horizontal-layout horizontal-menu 2-columns  " data-open="hover" data-menu="horizontal-menu"
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.php"><img class="brand-logo"
                                alt="modern admin logo" src="../assets/uploads/settings/adm.jpg">
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-user nav-item"><a
                                ...
                                data-toggle="dropdown"><span
                                    class="mr-1 user-name text-bold-700"><?php// echo $_SESSION['user']; ?></span><span
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow bg-success"
        role="navigation" data-menu="menu-wrapper">
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="index.php"><i
                            class="la la-home"></i><span>Dashboard</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="productCategory.php"><i
                            class="la la-tags"></i><span>Categories</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="product.php"><i
                            class="la la-archive"></i><span>Product</span></a>
                </li>
                <!-- <li class="nav-item"><a class="dropdown-toggle nav-link" href="sales.php"><i class="la la-rupee"></i><span>Sales</span></a> -->
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="suppliers.php"><i
                            class="la la-truck"></i><span>Sell Items</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="customers.php"><i
                            class="la la-users"></i><span>Customers</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="setting.php"><i
                            class="la la-users"></i><span>Setting</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="salesReport.php"><i
                            class="la la-users"></i><span>Sales Report</span></a>
                </li>
