                            ...
                            <div class="card-content collapse show div2" id="printMe">
                                <div class="card-body card-dashboard dataTables_wrapper dt-bootstrap">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h4 class="pull-right m-r-10 font-bold">Invoice Number <br><small
                                                    class="font-bold"><?=$getId;?></small></h4>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <h5 class="text-italic">Contact: <small><?=$res['customerNumber']?></small>
                                            </h5>
                                            <h5 class="text-italic">Address: <small><?=$res['customerAddress']?></small>
                                            </h5>
                                        ...
                                        <!-- </div> -->
                                        <div class="col-md-3 ">
                                            <h5 class="pull-right">ordered date: <br> <small><?=$res['date_add']?>
                                                </small> </h5>
                                        </div>
                                        <?php 
                                                }  ?>
                                            ...
                                            <table class="table m-t-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $object->getProductPrice($productCart['prdID']); ?>
                                                        </td>
                                                        <td><?php echo number_format($productCart['quantity'] *$object->getProductPrice($productCart['prdID']) , 2); ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-6 col-md-offset-3">
                                            <hr>
                                            <h3 class="text-right"> <strong>Total Price</strong> :
                                    ...
                                    <div class="hidden-print">
                                        <div class="pull-right">
                                            <a href="javascript:window.print()"
                                                class="btn btn-primary waves-effect waves-light printBtn"><i
